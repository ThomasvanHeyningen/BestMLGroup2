# -*- coding: utf-8 -*-
"""
Created on Wed Jun 03 22:34:53 2015
...
def find_best_ordering(data, column_name, y_name="status_group", prev_entr=2.0):
    """ Tries to find the best ordering of categories in a categorical
        variable.    
    """
    ...
    left = find_best_ordering(min_split_left, column_name, y_name, min_entropy_left)
    right = find_best_ordering(min_split_right, column_name, y_name, min_entropy_right)
