...
#   clf = AdaBoostClassifier(RandomForestClassifier(n_jobs=3, n_estimators=200, max_depth=15))
    ...
    clf3 = RandomForestClassifier(n_jobs=3, n_estimators=200, max_depth=27, random_state=180)
    ...
    gbm3=GradientBoostingClassifier(n_estimators=50, max_depth=18, max_features=15, min_samples_leaf=4,verbose=1, subsample=0.70, random_state=187)
    ...
    gbm4=GradientBoostingClassifier(n_estimators=50, max_depth=12, max_features=25, min_samples_leaf=4,verbose=1, subsample=0.95, random_state=186)
    ...
    clf4 = RandomForestClassifier(n_jobs=3, n_estimators=200, max_depth=20, random_state=188)
